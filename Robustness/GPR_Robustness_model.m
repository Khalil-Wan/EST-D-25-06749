...
[m_noise, n_noise]=size(X_test_35C02_0);
% Add different noise to different features, take Level III as an example.
Data_noise(:,1)=X_test_35C02_0(:,1)+0.03*randn(m_noise,1);% Temperature
Data_noise(:,122)=X_test_35C02_0(:,122)+0.05*randn(m_noise,1);% CT
Data_noise(:,123)=X_test_35C02_0(:,123)+0.05*randn(m_noise,1);% DT
Data_noise(:,124)=X_test_35C02_0(:,124)+0.05*randn(m_noise,1);% CE
% Frequence
